					...
					case 'text':
						...
						{	
							...
							$newsTplFooter="</Articles>
									...
									$con = mysql_connect("localhost","hyys","sny880707");								
								...
								while($row = mysql_fetch_assoc($result))
								{
									...
									$title = "".$row['d_name']."";
									$des ="";
									$url ="http://v.oxxxxx.cn/index.php?m=vod-detail-id-".$row['d_id'].".html";
									$picUrl1 ="".$row['d_pic']."";
								...
								//没有查找到的时候的回复
										...
										$des1 ="请联系我的微信，我可以免费帮您添加，微信号：tangtangboss";
 						...
 						if($keyword=="1")
						{
										...
										$des1 ="添加微信获得更多精彩影片，微信号：tangtangboss";
										//图片地址
						...
						if($keyword=="4")
						{
										...
										$des1 ="本视频为会员专属，设有密码，请添加微信免费获得，微信号：tangtangboss";
										//图片地址
